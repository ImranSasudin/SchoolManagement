		...
		<div class="page-content--bgf7">
							...
							<div class="au-breadcrumb-content">
								<div class="au-breadcrumb-left">
									...
									<ul class="list-unstyled list-inline au-breadcrumb__list">
										...
										<li class="list-inline-item">Add New Examination</li>
									</ul>
								</div>
			...
			<section class="welcome p-t-10">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="title-4">Add New Examination</h1>
					...
					<div class="col-6 mx-auto">
						<form action="../ExaminationController" method="post">
							...
							<div class="card h-100">
								<h4 class="card-header">Examination Details</h4>

								<div class="card-body">
									<div class="form-group">
										<br />
										<h4 class="text-left ">Examination Name* :</h4>
								...
								<div class="card-footer text-center ">
									<button type="submit" name="action" value="AddExamination"
